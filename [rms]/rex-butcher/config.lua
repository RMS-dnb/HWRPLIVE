...
Config.ButcherLocations = {
    ...
    {   -- armadillo
        name = 'Armadillo Butcher',
        prompt = 'arma-butcher',
        vector3(-3675.67, -2625.3, -13.76),
        npcmodel = `s_m_m_unibutchers_01`,
        npccoords = vector4(-3675.67, -2625.3, -13.76, 273.55),
        showblip = true
    },
    ...
    {   -- guarma
        ...
        vector3(1248.61, -7043.99, 41.83),
        npcmodel = `s_m_m_unibutchers_01`,
        npccoords = vector4(1248.61, -7043.99, 41.83, 227.5),
        showblip = true
    },

    {   -- guarma
        name = 'Manzanita Butcher',
        prompt = 'manza-butcher',
        vector3(-1976.85, -1651.19, 117.11),
        npcmodel = `s_m_m_unibutchers_01`,
        npccoords = vector4(-1976.85, -1651.19, 117.11, 27.61),
        showblip = true
    },
    {   -- Thieves Landing
        name = 'Thieves Landing Butcher',
        prompt = 'thieves-butcher',
        vector3(-1419.45, -2304.66, 43.09),
        npcmodel = `s_m_m_unibutchers_01`,
        npccoords = vector4(-1419.45, -2304.66, 43.09, 99.94),
        showblip = true
    },
    {   -- Wapiti
        name = 'Wapiti Butcher',
        prompt = 'wapiti-butcher',
        vector3(441.15, 2140.48, 243.67),
        npcmodel = `s_m_m_unibutchers_01`,
        npccoords = vector4(441.15, 2140.48, 243.67, 268.92),
        showblip = true
    },
...
Config.Animal = {
    ...
    --     rewarditem = 'legendary_moon_beaver_pelt',
    --     rewardmoney = 3,
    ...
    --     rewarditem = 'legendary_zizi_beaver_pelt,',
    --     rewardmoney = 4,
    ...
    --     rewarditem = 'legendary_night_beaver_pelt',
    --     rewardmoney = 4,
 
    -- },

    { -- A_C_FrogBull_01/ Bullfrog
        pelthash    = -930822792,
        name        = 'Bullfrog',
        rewardmoney = 1,
        rewarditem = 'frog_meat'
