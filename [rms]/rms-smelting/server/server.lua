...
RegisterNetEvent('rex-smelting:server:finishsmelting', function(data)
    ...
    TriggerEvent('rsg-log:server:CreateLog', 'smelting', Lang:t('server.lang_1'), 'green', firstname..' '..lastname..' ('..citizenid..Lang:t('server.lang_2')..RSGCore.Shared.Items[receive].label)
end)
