...
function PropPlacer(proptype, prop, item)
    ...
    while true do
        ...
        if PromptHasHoldModeCompleted(SetPrompt) then
            ...
            TriggerEvent('rms-moonshiner:client:placeNewProp', proptype, PropHash, item, pPos, heading )
...
RegisterNetEvent('rms-moonshiner:client:createprop', function(proptype, prop, item)
