...
function PropPlacer(proptype, prop)
    ...
    while true do
        ...
        if PromptHasHoldModeCompleted(SetPrompt) then
            ...
            TriggerEvent('rex-moneybox:client:placeNewProp', proptype, PropHash, pPos, heading )
...
RegisterNetEvent('rex-moneybox:client:createmoneybox', function(proptype, prop)
