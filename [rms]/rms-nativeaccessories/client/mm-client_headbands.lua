...
-- -- Testing purposes
-- if Config.UseAccessoriesCommand then
--     RegisterCommand("Na", function(source, args)
--         if args ~= nil and args[1] ~= nil then
--             AttachHeadbandTypeOnPlayerPed("Na" .. tostring(args[1]))
--         end
--     end, false)
-- end

-- -- Removing all the headbands
-- RegisterCommand("DNa", function(source, args)
--     if args ~= nil then
--         DHeadband()
--     end
-- end, false)