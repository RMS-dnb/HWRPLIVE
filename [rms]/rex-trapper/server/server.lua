        ...
        for k, v in pairs(Player.PlayerData.items) do
            if Player.PlayerData.items[k] ~= nil then
                ...
                elseif Player.PlayerData.items[k].name == "perfect_raccoon_pelt" then 
                    ...
                    haspelts = true
                    -- skunk_pelt
                elseif Player.PlayerData.items[k].name == "skunkfur" then 
                    price = price + (Config.PoorPeltPrice * Player.PlayerData.items[k].amount)
                    Player.Functions.RemoveItem("skunkfur", Player.PlayerData.items[k].amount, k)
                    haspelts = true
                ...
                elseif Player.PlayerData.items[k].name == "reptile_skin" then 
                    ...
                    TriggerClientEvent('inventory:client:ItemBox', src, RSGCore.Shared.Items["reptile_skin"], "remove")
                    haspelts = true
                elseif Player.PlayerData.items[k].name == "watersnake_skin" then 
                    price = price + (Config.ReptileSkinPrice * Player.PlayerData.items[k].amount)
                    Player.Functions.RemoveItem("watersnake_skin", Player.PlayerData.items[k].amount, k)
                    TriggerClientEvent('inventory:client:ItemBox', src, RSGCore.Shared.Items["watersnake_skin"], "remove")
                    haspelts = true
                elseif Player.PlayerData.items[k].name == "blacktail_skin" then 
                    price = price + (Config.ReptileSkinPrice * Player.PlayerData.items[k].amount)
                    Player.Functions.RemoveItem("blacktail_skin", Player.PlayerData.items[k].amount, k)
                    TriggerClientEvent('inventory:client:ItemBox', src, RSGCore.Shared.Items["blacktail_skin"], "remove")
                    haspelts = true
                elseif Player.PlayerData.items[k].name == "ferdelance_skin" then 
                    price = price + (Config.ReptileSkinPrice * Player.PlayerData.items[k].amount)
                    Player.Functions.RemoveItem("ferdelance_skin", Player.PlayerData.items[k].amount, k)
                    TriggerClientEvent('inventory:client:ItemBox', src, RSGCore.Shared.Items["ferdelance_skin"], "remove")
                    haspelts = true
                elseif Player.PlayerData.items[k].name == "cottonmouth_skin" then 
                    price = price + (Config.ReptileSkinPrice * Player.PlayerData.items[k].amount)
                    Player.Functions.RemoveItem("cottonmouth_skin", Player.PlayerData.items[k].amount, k)
                    TriggerClientEvent('inventory:client:ItemBox', src, RSGCore.Shared.Items["cottonmouth_skin"], "remove")
                    haspelts = true
                elseif Player.PlayerData.items[k].name == "redboa_skin" then 
                    price = price + (Config.ReptileSkinPrice * Player.PlayerData.items[k].amount)
                    Player.Functions.RemoveItem("redboa_skin", Player.PlayerData.items[k].amount, k)
                    TriggerClientEvent('inventory:client:ItemBox', src, RSGCore.Shared.Items["redboa_skin"], "remove")
                    haspelts = true
                elseif Player.PlayerData.items[k].name == "diamondback_skin" then 
                    price = price + (Config.ReptileSkinPrice * Player.PlayerData.items[k].amount)
                    Player.Functions.RemoveItem("diamondback_skin", Player.PlayerData.items[k].amount, k)
                    TriggerClientEvent('inventory:client:ItemBox', src, RSGCore.Shared.Items["diamondback_skin"], "remove")
                    haspelts = true
                elseif Player.PlayerData.items[k].name == "feather" then 
                    ...
                    TriggerClientEvent('inventory:client:ItemBox', src, RSGCore.Shared.Items["feather"], "remove")
                    haspelts = true
