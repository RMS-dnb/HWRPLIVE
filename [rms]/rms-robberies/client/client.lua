    ...
    for id, info in pairs(Config.StoreRobberies) do
        CreateThread(function()
            ...
            exports.ox_target:addLocalEntity(safe, {
                ...
                -- only show if player has a lockpick
                canInteract = function(entity, distance, coords, name)
                    local hasItem = lib.callback.await('y0-storeRobbery:checkItem', false, 'lockpick')
                    return hasItem
                end,
                ...
                onSelect = function()
                    ...
                    TriggerServerEvent('rsg-tips:server:addCriminalActivity', "Robbery in Progress", nil, GetEntityCoords(PlayerPedId()))
