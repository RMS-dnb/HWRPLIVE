...
-- Copiando estrutura para tabela brasatech.medic_fines
CREATE TABLE IF NOT EXISTS `medic_fines` (
...
-- Copiando dados para a tabela brasatech.medic_fines: ~0 rows (aproximadamente)
DELETE FROM `medic_fines`;
