    ...
    if player then
        if itemData then
            ...
            elseif itemData['type'] == 'weapon' then
                amount = 1
                info.serial = tostring(RSGCore.Shared.RandomInt(2) .. RSGCore.Shared.RandomStr(3) .. RSGCore.Shared.RandomInt(1) .. RSGCore.Shared.RandomStr(2) .. RSGCore.Shared.RandomInt(3) .. RSGCore.Shared.RandomStr(4))
                info.quality = 100
            end
