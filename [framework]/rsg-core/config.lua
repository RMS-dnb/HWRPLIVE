...
RSGConfig.MaxPlayers = GetConvarInt('sv_maxclients', 128) -- Gets max players from config file, default 48
...
RSGConfig.Money = {}
RSGConfig.Money.MoneyTypes = { cash = 50, bank = 0, valbank = 0, rhobank = 0, blkbank = 0, armbank = 0, vanbank = 0, annebank = 0, strawbank = 0, bloodmoney = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
RSGConfig.Player = {}
RSGConfig.Player.HungerRate = 3.8 -- Rate at which hunger goes down.
RSGConfig.Player.ThirstRate = 3.2 -- Rate at which thirst goes down.
