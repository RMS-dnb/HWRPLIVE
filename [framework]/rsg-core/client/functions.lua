...
function RSGCore.Functions.Notify(title, text, notifyType, duration)
    ...
    if type(text) == "table" then
        ...
        lib.notify({ title = title, description = text, duration = duration, type = notifyType, position = position})
    end
end
