...
Config.PedList = {
    -- Farming Seed Locations
    {    -- Saint Denis 
        model = `cs_aberdeenpigfarmer`,
        coords = vector4(2845.55, -1225.99, 47.66, 8.03),
    },
    {    -- Blackwater 
        model = `cs_aberdeenpigfarmer`,
        coords = vector4(-839.62, -1355.4, 43.6, 93.64),
    },
    {    -- Armadillo 
        model = `cs_aberdeenpigfarmer`,
        coords = vector4(-3691.12, -2622.97, -13.7, 359.94),
    },
    -- Ore Seller Location's
    {    -- Annesburg Location 
        model = `a_m_m_asbminer_02`,
        coords = vector4(2799.82, 1350.15, 73.18, 273.58),
    },
    {    -- gaptooth location 
        model = `a_m_m_asbminer_02`,
        coords = vector4(-5984.12, -3224.48, -21.18, 298.57),
    },
    {    -- Near Strawberry Mine 
        model = `a_m_m_asbminer_02`,
        coords = vector4(-1386.55, 1152.42, 225.02, 36.44),
    },
    -- trappers
    {    -- trapper vendor Valentine 
        model = `u_m_m_valbeartrap_01`,
        coords = vector4(-333.4648, 765.93096, 116.44655, 93.870338),
    },
    {    -- trapper vendor st d 
        model = `u_m_m_valbeartrap_01`,
        coords = vector4(2819.4865, -1331.235, 46.51012, 45.151897),
    },
    {    -- anneburg vendor 
        model = `u_m_m_valbeartrap_01`,
        coords = vector4(2940.5637, 1310.312, 44.479141, 245.08056),
    },
    {    -- wapiti vendor 
        model = `msp_native1_males_01`,
        coords = vector4(466.34167, 2247.0439, 248.36877, 132.34631),
    },
    {    -- strawberry vendor 
        model = `u_m_m_valbeartrap_01`,
        coords = vector4(-1752.863, -390.5403, 156.27529, 14.834065),    
    },
    {    -- BLACKWATER vendor 
        model = `u_m_m_valbeartrap_01`,
        coords = vector4(-755.6054, -1287.679, 43.647121, 274.45422),    
    },
    {    -- armadillo vendor 
        model = `u_m_m_valbeartrap_01`,
        coords = vector4(-3695.61, -2625.2, -13.81, 262.32),    
    },
    {    -- tumbleweed vendor 
        model = `u_m_m_valbeartrap_01`,
        coords = vector4(-5508.935, -2944.571, -1.900522, 313.25091),    
    },
    {    -- rhodes meat buyer
        model = `u_m_m_valbeartrap_01`,
        coords = vector4(1301.2364, -1279.027, 76.028541, 162.67347),    
    },
    
    {    -- van horn meat buyer
        model = `u_m_m_valbeartrap_01`,
        coords = vector4(2992.6, 569.45, 44.47, 150.27),    
    },

    {    -- colter meat buyer
        model = `u_m_m_valbeartrap_01`,
        coords = vector4(-1355.32, 2417.68, 307.4, 253.08),    
    },

    {    --BW tobacco
        model = `A_M_M_WAPWARRIORS_01`,
        coords = vector4(-791.39, -1315.43, 43.67, 48.68),    
    },
    {    --BW tobacco
        model = `A_M_M_BLWObeseMen_01`,
        coords = vector4(2701.99, -1382.1, 46.5, 130.17),    
    },
     {    --strawberry blueprints
        model = `A_M_M_BLWObeseMen_01`,
        coords = vector4(-1792.8, -382.31, 157.05, 146.37),    
    },
    {    --Wapiti
        model = `MSP_NATIVE1_MALES_01`,
        coords = vector4(434.06, 2193.14, 246.79, 40.24),    
    },
    {    --Wapiti
        model = `cs_aberdeenpigfarmer`,
        coords = vector4(499.1, -241.58, 143.89, 243.7),    
    },
    {    --PawnShop Vanhorn
        model = `msp_mob0_males_01`,
        coords = vector4(3018.95, 557.76, 47.83, 306.58),    
    },
    {    --PawnShop Tumbleweed
        model = `msp_mob0_males_01`,
        coords = vector4(-5506.94,-2913.1,1.68,121.59),    
    },
    {   -- Casino Boat Docked Chip Seller
        model = `gc_lemoynecaptive_males_01`,
        coords = vector4(2884.07, -1420.6, 43.33, 27.8),    
    },
    {    -- Casino Boat Docked Chip Buyer
        model = `rcsp_sadie1_males_01`,
        coords = vector4(2889.62, -1413.69, 43.33, 68.63),    
    },
    {    -- BP Shops
        model = `mp_u_m_m_gunslinger3_shotgunner_01`,
        coords = vector4(-5394.09, -3664.92, -24.92, 131.37),    
    },
    {    -- BP Shops
        model = `mp_u_m_m_gunslinger3_shotgunner_01`,
        coords = vector4(-1881.13, 1319.13, 201.49, 325.18),    
    },
    {    -- BP Shops
        model = `mp_u_m_m_gunslinger3_shotgunner_01`,
        coords = vector4(-1354.97, -2298.68, 43.47, -145.67),    
    },
...
--the ones below are for external scripts, but can use as a template.
    ...
    {   -- valentine townhall
        ...
        coords = vector4(-280.75, 817.57, 119.36, 283.06),
    },
    {   -- valentine townhall
        model = `U_M_M_RHDDoctor_01`,
        coords = vector4(2727.88, -1232.01, 50.38, 81.97),
    },
    {   -- valentine townhall
        model = `U_M_M_RHDDoctor_01`,
        coords = vector4(1365.89, -1307.08, 77.12, 90.56),
    },
    {   -- valentine townhall
        model = `U_M_M_RHDDoctor_01`,
        coords = vector4(-1800.58, -432.56, 156.48, 251.46),
    },
