...
RSG.WelcomeText = "WELCOME TO HIGHWATER RP"
...
RSG.GroupPromptText = 'Highwater Creator'
...
RSG.Zones1 = {
    ...
    {
        location = 'valentine',
        blipcoords = vector3(-323437.07, 803437.77, 113437.89),
        fittingcoords = vector4(-323437.765, 83407.769, 113437.894, 254.593),
        quitcoords = vector4(-334326.033, 803435.976, 133417.882, 241.450),
        promtcoords = vector3(-323345.9504, 803436.58251, 13417.8897),
        showblip = false
    },
    -- {
    --     location = 'rhodes',
...
RSG.Cloakroom = {
    vector3(-222325.29, 763336.24, 113337.48),   -- valentine
