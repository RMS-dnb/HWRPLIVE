...
AddEventHandler("rsg-pinboard:set_link", function(title,poster_link,city)
    ...
    if poster_link ~= nil then 
        ...
        -- Get the appropriate webhook for the city
        local webhook = Config.webhooks[city] or Config.defaultWebhook
        
        --Discord(webhook, title, poster_link, 3447003, city, xPlayerName)
        Discord(webhook, title, poster_link, 3447003, city)
...
--     -- Get the source player and their character data using rsgcore
--     local _source = source
...
--     local logs = ""
--     local avatar = "https://files.fivemerr.com/images/dc8acb3f-4065-4ed5-a431-8610d99f979b.png"
--     if string.match(description, "http") then
--         logs = {
--             {
--                 ["color"] = color,
--                 ["title"] = title,
--                 ["image"] = {["url"] = description},
--                 ["footer"] = {["text"] = "Town: " .. city, ["icon_url"] = "https://files.fivemerr.com/images/dc8acb3f-4065-4ed5-a431-8610d99f979b.png"}
--             }
--         }
--     else
--         logs = {
...
function Discord(webhook, title, description, color, city)
    local logs = ""
    local avatar = "https://files.fivemerr.com/images/dc8acb3f-4065-4ed5-a431-8610d99f979b.png"
    local name = "Anonymous" -- ✅ Fully anonymous
        ...
        logs = {
            {
                ...
                ["title"] = title,
                ["image"] = {["url"] = description},
                ["footer"] = {["text"] = "Town: " .. city, ["icon_url"] = avatar}
            }
        }
    else
        logs = {
