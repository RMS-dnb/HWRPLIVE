...
Config.EagleEye = {
    ...
    everyone = {
        enabled = false, -- Default: true (only specific jobs can use Eagle Eye on false)
    },
    vallaw = {
        enabled = false, 
    },
...
Config.Discord = {
    DiscordAppID = 1247343749118300160,
    AppBigAssetID = 'highwaterrp.png!',
    AppBigAssetText = 'big text img!',
    AppSmallAssetID = 'small_img.png',
    AppSmallAssetText = 'small text img!',
    FirstButtonPlaceholder = 'Discord',
    FirstButtonLink = 'https://discord.gg/XtzF9UqYeH',
    SecondButtonPlaceholder = 'Join Game',
    SecondButtonLink = 'https://cfx.re/join/bav634',
...
Config.DiscordWHImage = 'https://files.fivemerr.com/images/dc8acb3f-4065-4ed5-a431-8610d99f979b.png'
Config.DiscordWHLogUserName = 'Highwater Gaming Logs'
Config.DiscordWHAuthorName = 'HWRP'
