...
Config.Locale = {
    ["en"] = {
        ...
        ["ointment"] = "Applying Ointment..",
        ["incense"] = "Lighting Incense..",
    },
    ["de"] = {
...
Config.mapTypeOnFoot = 3        -- Radar type when on foot. 0 = Off, 1 = Regular, 2 = Expanded, 3 = Simple (compass).
Config.mapTypeOnMount = 3       -- Radar type when on horse. Same options as on foot.
Config.SaveStatusInterval = 3 -- Minute
Config.DisableRedmCores = true

Config.SpeakerSettings = {
    SpeakerIcon = false, --- If false, the icon will not appear when players are talking
...
Config.VoiceChat = "saltychat" -- "saltychat" -- pma-voice
...
Config.HudAutoHide = false  -- For example, if stress is 0, it will be hidden automatically.
Config.CheckHungerAndThirstTick = 120 -- second
Config.decreaseSprintRemoveValueTick = 1 -- Second
Config.HudSettings = {
    Stress = { -- or false
        speeding = false, -- or false (Will it gain stress when running fast or running with the wagon?)
        shooting = true, -- or false (Will the stress level increase when shooting?)
        speedingValue = 100.0, -- If the player's speed exceeds 35.0, the stress level will start to increase. horse and vagon maximum speed 35.0 player run 17.5
        speedStress = 1.0, -- How much stress the player will gain every 1 second if they exceed the speedingValue limit
        shootingchange = 50, -- 1-100 What percentage chance the player will win stress when he shoots
