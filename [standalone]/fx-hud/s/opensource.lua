...
RegisterCommand("hudload", function(source, args, raw)
    -- Block usage
    TriggerClientEvent('chat:addMessage', source, {
        args = {'SYSTEM', 'The /hudload command is disabled on this server.'}
    })
end, true) -- false means no permission check is enforced, so this captures all