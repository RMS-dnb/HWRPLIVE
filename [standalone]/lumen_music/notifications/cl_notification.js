...
onNet('lumen_music:ShowAdvancedNotificationJS', (title, subTitle, dict, icon, duration) => {
...
onNet('lumen_music:ShowTooltip', (text, duration) => {
...
onNet('lumen_music:ShowObjective', (text, duration) => {
