...
if SERVER then
    ...
    local function printDecorative(color, message)
        ...
        print("    Portal Cfx: https://portal.cfx.re/assets/granted-assets")
                ...
                if err == 200 then
                    ...
                    if latestVersion then
                        ...
                        if currentVersion == latestVersion then
                            ...
                            printDecorative("light_red", "Version is NOT up to date! Please update from Portal Cfx! \n Script Version: "..latestVersion.." | Server Version: "..currentVersion)
                        end
                    else
