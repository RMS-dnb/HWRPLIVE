...
RegisterNetEvent('phils-bounty:client:openhuntermenu', function(location, wagonspawn)
    lib.registerContext({
        ...
        options = {
            ...
            -- },
            {
                title = 'Cremate Deceased and collect your $',
                description = 'Sell all bounties stored in your wagon.',
...
RegisterNetEvent('phils-bounty:client:addnpc', function(data)
    ...
    local holding = Citizen.InvokeNative(0xD806CD2A4F2C2996, ped) -- Get entity player is holding
    if not holding or holding == 0 then
        print("Debug: No entity held by player")
    ...
    local holdinglooted = Citizen.InvokeNative(0x8DE41E9902E85756, holding) -- Check if ped is looted
    local pedType = Citizen.InvokeNative(0xFF059E1E4C01E63C, holding) -- Get ped type
