...
Config.WebHook = "https://discord.com/api/webhooks/1356468452499394711/IqH00Dmrwb9jexIlvvpyWp7sUSy2QPjmAv_m3uH-tuk1URyrwbIEjABhuSNG5e38Zwfn"
...
Config.ServerName = "NUTTY MONEY CHECK"
...
Config.SendLogByTime = {
    ...
    time = 30, --How long do you want the log to be sent (default: 60 minutes)
}
...
Config.AdditionalBanks = {"bank_1", "bank_2", "another_bank"}  -- Add any other bank names here
